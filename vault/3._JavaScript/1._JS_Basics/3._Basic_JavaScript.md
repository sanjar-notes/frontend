...
2. ``bigint``
3. ``string`` - both kinds of quotes are OK, you can even use backticks. Concatenation using ``+``. Strings can be like numbers(and vice versa). e.g. '``2.3'*2 = 4.6``. [Escape](vault/3._JavaScript/1._JS_Basics/3._Basic_JavaScript/pasted_image001.png) character same as C++. Strings can span multiple lines.
...
![](vault/3._JavaScript/1._JS_Basics/3._Basic_JavaScript/pasted_image.png)
